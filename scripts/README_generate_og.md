...
How it works
- The script reads `seo.json` and looks for route entries that contain `ogImage`.
...
- Screenshots are saved to the `ogImage` path defined in `seo.json` under `public/` as WebP images.
